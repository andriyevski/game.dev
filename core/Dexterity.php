...
if (isset($_SESSION['login'])){
    ...
    $UP_Strength=mysql_query("UPDATE Players SET Dexterity=Dexterity + '1'  WHERE login = '$login'")or die("Invalid query: " . mysql_error());//Обновляю запись в БД
  ...
  <head>
   <meta http-equiv='Refresh' content='0; URL=".$_SERVER['HTTP_REFERER']."'>
    ...
    //header("Refresh: 1; URL=$URL");
        ...
        Echo "Ошибка скрипта: Dexterity.php / Выход за пределы возможного !";
    }
