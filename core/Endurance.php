...
if (isset($_SESSION['login'])){
    ...
    $UP_Strength=mysql_query("UPDATE Players SET Endurance=Endurance + '1'  WHERE login = '$login'")or die("Invalid query: " . mysql_error());//Обновляю запись в БД
...
<html>
  <head>
   <meta http-equiv='Refresh' content='0; URL=".$_SERVER['HTTP_REFERER']."'>
    ...
    Echo "Ошибка скрипта: Endurance.php / Выход за пределы возможного !";
}
